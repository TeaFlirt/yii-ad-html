...
|----------|--------|----------|
| **🏠 Главная** | [index.html](index.html) | Основная страница с каталогом чая |
| **ℹ️ О нас** | [about.html](about.html) | История, команда и ценности |
| **📞 Контакты** | [contact.html](contact.html) | Форма связи и информация |
| **🔐 Вход** | [login.html](login.html) | Страница авторизации |
| **📝 Регистрация** | [signup.html](signup.html) | Создание аккаунта |
| **👋 Приветствие** | [welcome.html](welcome.html) | Страница после регистрации |
| **🗺️ Навигация** | [navigation.html](navigation.html) | Карта всех страниц сайта |
